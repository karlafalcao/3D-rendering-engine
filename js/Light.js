 ...
 * | 1                                     | ; ka - Coeficiente de reflexao ambiental
...
Light.prototype.calculateLightSource = function (camera) {
	...
	var xView = vec3.dot(this.lightSource, camera.rightVector);
	var yView = vec3.dot(this.lightSource, camera.frontVector);
	var zView = vec3.dot(this.lightSource, camera.upVector);

	this.lightSource[0] = xView;
	this.lightSource[1] = yView;
	this.lightSource[2] = zView;
};